import { CalendarDots, CarProfile, ChartPieSlice, ClipboardText, GearSix, ListChecks, SignOut, UsersThree } from "@phosphor-icons/react";
...
const links = [
  ...
  { to: "/distribution", label: "توزيع المناديب", icon: ListChecks },
